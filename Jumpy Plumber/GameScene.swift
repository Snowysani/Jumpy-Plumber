...
//  Jumpy Plumber
//
//  Created by Michael Gallegos on 3/15/16.
//  Copyright (c) 2016 Michael Gallegos. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func setupHair() {
        ...
        hair.position = CGPoint(x: 27 - hair.size.width/2, y: 28 - hair.size.height/2)
    ...
    func setupLabel() {
        ...
        scoreLabel.fontColor = SKColor(red: 0/255.0, green: 0/255.0, blue: 0/255.0, alpha: 1.0)
    ...
    func setupScorecard() {
        ...
        lastScore.fontColor = SKColor(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 1.0)
        ...
        bestScoreLabel.fontColor = SKColor(red: 255.0/255.0, green: 255.0/255.0, blue: 255.0/255.0, alpha: 1.0)
...
//            ])))
    ...
    func setupPlayerAnimation() {
        ...
        let playerAnimation = SKAction.animateWithTextures(textures, timePerFrame: 0.25)
    ...
    func createObstacle() -> SKSpriteNode {
        let sprite = SKSpriteNode(imageNamed: "Coral")
    ...
    func flapPlayer() {
        ...
        lastTouchY = player.position.y
            ...
            // Move hair
            let moveUp = SKAction.moveByX(0, y: 10, duration: 0.15)
            moveUp.timingMode = .EaseInEaseOut
            let moveDown = moveUp.reversedAction()
            hair.runAction(SKAction.sequence([moveUp, moveDown]))
    ...
    func shareScore() {
        ...
        let initialTextString = "I scored \(score) points in Donald the Dragon!"
    ...
    func learn() {
        let urlString = "http://everythingisayisright.com"
        let url = NSURL(string: urlString)
        UIApplication.sharedApplication().openURL(url!)
    }
